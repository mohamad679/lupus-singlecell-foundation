...
def test_stage4_f002_is_current_project_feature():
...
def test_stage4_f002_run_plan_preserves_safety_locks():
    state = STATE_PATH.read_text()
    block = _block_between(state, "stage4_real_donor_aggregation_run_plan:")
...
def test_stage4_f002_current_feature_document_describes_safe_scope():
    ...
    assert "does not open, load, parse, or aggregate" in current_feature
